...
Revision ID: 841138072c0b
Revises:
Create Date: 2026-03-30 16:13:54.828151
...
def upgrade() -> None:
    ...
    sa.Column('start_entity_type', sa.Enum('CLASS', 'INTERFACE', name='entitytype'), nullable=False),
    sa.Column('end_entity_type', sa.Enum('CLASS', 'INTERFACE', name='entitytype'), nullable=False),
